export const COURSES: any = {
  ...
  17: {
    id: 17,
    description: 'Reactive Angular Application',
  ...
  3: {
    id: 3,
    description: 'RxJs In Practice Application',
  ...
  12: {
    id: 12,
    description: 'Angular Testing Application',
  ...
  1: {
    id: 1,
    description: 'Serverless Angular with Firebase Application',
  ...
  6: {
    id: 6,
    description: 'Angular Security Application - Web Security Fundamentals',
  ...
  7: {
    id: 7,
    description: 'Angular PWA - Progressive Web Apps Application',
  ...
  9: {
    id: 9,
    description: 'The Complete Typescript Application',
  ...
  11: {
    id: 11,
    description: 'Angular Material Application',
...
export const LESSONS = {
  ...
  11: {
    id: 11,
    'description': 'Application Helicopter View',
    'duration': '08:19',
    'seqNo': 1,
    courseId: 6
  },
  ...
  22: {
    id: 22,
    'description': 'Application Kick-Off - Install Node, NPM, IDE And Service Workers Section Code',
    'duration': '07:19',
    'seqNo': 1,
    courseId: 7
  },
  ...
  // Serverless Angular with Firebase Application
...
// Angular Testing Application
  ...
  40: {
    id: 40,
    description: 'Angular Testing Application - Helicopter View',
    'duration': '5:38',
    'seqNo': 1,
    courseId: 12
  },
  ...
  50: {
    id: 50,
    'description': 'Welcome to the Angular Ngrx Application',
    'duration': '6:53',
    'seqNo': 1,
    courseId: 4
  ...
  51: {
    id: 51,
    'description': 'The Angular Ngrx Architecture Application - Helicopter View',
    'duration': '5:52',
    'seqNo': 2,
    courseId: 4
  },
